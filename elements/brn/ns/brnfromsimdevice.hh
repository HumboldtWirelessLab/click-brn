#ifndef CLICK_BRNFROMSIMDEVICE_HH
#define CLICK_BRNFROMSIMDEVICE_HH
...
/*
 * =title BRNFromSimDevice.u
 * =c
 * BRNFromSimDevice(DEVNAME [, PROMISC? [, MAXPACKETSIZE]])
 * =s netdevices
 * reads packets from a simulator device
 * =d
 *
 * This manual page describes the user-level version of the BRNFromSimDevice
 * element.
 *
 * =e
 *   BRNFromSimDevice(eth0, 0) -> ...
 *
 * =a ToSimDevice.u, FromDump, ToDump, FromDevice(n) */

class BRNFromSimDevice : public Element {
 ...
 public:
  ...
  const char *class_name() const	{ return "BRNFromSimDevice"; }
