...
BRNFromSimDevice::BRNFromSimDevice()
...
int
BRNFromSimDevice::configure(Vector<String> &conf, ErrorHandler *errh)
{
...
int
BRNFromSimDevice::initialize(ErrorHandler *errh)
{
  if (!_ifname)
...
void
BRNFromSimDevice::set_annotations(Packet *p,int ptype)
{
...
int
BRNFromSimDevice::incoming_packet(int ifid,int ptype,const unsigned char* data,
...
CLICK_ENDDECLS
ELEMENT_REQUIRES(ns)
EXPORT_ELEMENT(BRNFromSimDevice)
