#ifndef CLICK_BRNTOSIMDEVICE_HH
#define CLICK_BRNTOSIMDEVICE_HH
...
/*
 * =title BRNToSimDevice.u
 * =c
 * BRNToSimDevice(DEVNAME [, ENCAP])
 * =s netdevices
 * sends packets to simulated network device
 * =d
 *
 * This manual page describes the BRNToSimDevice element.
 *
...
class BRNToSimDevice : public Element { public:
  
  BRNToSimDevice();
  ~BRNToSimDevice();
  
  const char *class_name() const		{ return "BRNToSimDevice"; }
