...
CompressedAlarmingState::CompressedAlarmingState():
...
int
CompressedAlarmingState::configure(Vector<String> &conf, ErrorHandler* errh)
{
...
int
CompressedAlarmingState::initialize(ErrorHandler *)
{
  return 0;
}

CompressedAlarmingState::AlarmNode *
CompressedAlarmingState::get_node_by_address(uint8_t type, const EtherAddress *ea)
{
...
uint32_t
CompressedAlarmingState::update_alarm(int type, const EtherAddress *ea, int id, int hops, const EtherAddress *fwd)
{
  uint32_t result = 0;
...
void
CompressedAlarmingState::update_neighbours()
{
  Vector<EtherAddress> neighbors;
  int fwd_i;
...
void
CompressedAlarmingState::get_incomlete_forward_types(int /*max_fraction*/, Vector<int> *types)
{
  int type, t_i;
...
void
CompressedAlarmingState::get_incomlete_forward_nodes(int max_fraction, int max_retries, int /*max_hops*/, int type, Vector<AlarmNode*> *nodes)
{
  for( int an_i = _alarm_nodes.size()-1; an_i >= 0; an_i--) {
 ...
 */
void
CompressedAlarmingState::trigger_alarm()
{
...
String
CompressedAlarmingState::get_state()
{
  StringAccum sa;
...
{
  return ((CompressedAlarmingState *)e)->get_state();
}

void
CompressedAlarmingState::add_handlers()
{
...
CLICK_ENDDECLS
EXPORT_ELEMENT(CompressedAlarmingState)
