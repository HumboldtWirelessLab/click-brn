...
#include "batmanerrorforwarder.hh"
...
BatmanErrorForwarder::BatmanErrorForwarder()
...
int
BatmanErrorForwarder::configure(Vector<String> &conf, ErrorHandler* errh)
{
...
int
BatmanErrorForwarder::initialize(ErrorHandler *)
{
  return 0;
}

void
BatmanErrorForwarder::push( int /*port*/, Packet *packet )
{
  click_ether *et;
  batman_header *bh;
...
void
BatmanErrorForwarder::add_handlers()
{
