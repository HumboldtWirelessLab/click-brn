...
#ifndef BRNETXMETRIC_HH
#define BRNETXMETRIC_HH
...
/*
 * =c
 * BRNETXMetric(LinkStat, LinkStat)
 * =s Wifi
 ...
 */
inline unsigned txcount2_metric(int ack_prob, int data_prob, int data_rate) 
{
...
class BRNETXMetric : public GenericMetric {

public:

  BRNETXMetric();
  ~BRNETXMetric();
  const char *class_name() const { return "BRNETXMetric"; }
