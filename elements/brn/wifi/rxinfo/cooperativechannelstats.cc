...
void CooperativeChannelStats::push(int, Packet *p)
{
    ...
    struct cooperative_channel_stats_header *ccsh = (struct cooperative_channel_stats_header *)data;
