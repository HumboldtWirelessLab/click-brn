...
Ath2Encap::simple_action(Packet *p)
{
  ...
  if (ceh->max_tries > 0) desc->xmit_tries0 = ceh->max_tries - 1;
  if (ceh->max_tries1 > 0) desc->xmit_tries1 = ceh->max_tries1 - 1;
  if (ceh->max_tries2 > 0) desc->xmit_tries2 = ceh->max_tries2 - 1;
  if (ceh->max_tries3 > 0) desc->xmit_tries3 = ceh->max_tries3 - 1;
