#ifndef CLICK_BRNBEACONSOURCE_HH
#define CLICK_BRNBEACONSOURCE_HH
...
class BrnBeaconSource : public Element { public:
  
  BrnBeaconSource();
  ~BrnBeaconSource();

  const char *class_name() const	{ return "BrnBeaconSource"; }
