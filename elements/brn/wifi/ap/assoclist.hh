...
#ifndef ASSOCLISTELEMENT_HH
#define ASSOCLISTELEMENT_HH
 ...
 * =d
 */
class AssocList : public Element 
{
//------------------------------------------------------------------------------
// Types
//------------------------------------------------------------------------------
public:
  ...
  protected:
    ...
    String         _dev_name; ///< Device the client is connected to 
  ...
  protected:
    ...
    inline void set_dev_name(const String& s) { 
      _dev_name = s; 
    }
...
//------------------------------------------------------------------------------
public:
  const char *class_name() const	{ return "AssocList"; }
