...
#ifndef NHOPNEIGHBOURINGCOMPRESSEDPINGELEMENT_HH
#define NHOPNEIGHBOURINGPINGCOMPRESSEDELEMENT_HH
...
/*
 * =c
 * NHopNeighbouringCompressedPing()
 * =s
...
class NHopNeighbouringCompressedPing : public BRNElement {
 ...
 public:
  ...
  const char *class_name() const  { return "NHopNeighbouringCompressedPing"; }
