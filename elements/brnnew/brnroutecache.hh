 ...
 * @brief Declaration of the BrnRouteCache class.
 */

#ifndef BRNROUTECACHE_HH_
#define BRNROUTECACHE_HH_
 ...
 * 
 */
class BrnRouteCache : public Element
{
//----------------------------------------------------------------------
// Types
//----------------------------------------------------------------------
...
public:
	BrnRouteCache();
	virtual ~BrnRouteCache();

  const char* class_name() const { return "BrnRouteCache"; }
