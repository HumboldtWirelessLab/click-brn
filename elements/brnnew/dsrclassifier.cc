...
#include "dsrclassifier.hh"

CLICK_DECLS

DSRClassifier::DSRClassifier()
...
int
DSRClassifier::configure(Vector<String> &conf, ErrorHandler *)
{
...
int
DSRClassifier::initialize(ErrorHandler *)
{
  return 0;
}
...
String 
DSRClassifier::getNextArg(const String &s)
{
  char buf[256];
