#ifndef CLICK_PACKET_LOSS_GRAPH_NODE_HH
#define CLICK_PACKET_LOSS_GRAPH_NODE_HH
...
class PACKET_LOSS_GRAPH_NODE : public Element { public:

  PACKET_LOSS_GRAPH_NODE();
  ~PACKET_LOSS_GRAPH_NODE();

  const char *class_name() const		{ return "PACKET_LOSS_GRAPH_NODE"; }
