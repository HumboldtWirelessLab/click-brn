...
#ifndef CLICK_CHANNELERRORDETECTION_HH
#define CLICK_CHANNELERRORDETECTION_HH
...
class ChannelErrorDetection : public BRNElement {
  ...
  public:
    ...
    const char *class_name() const  { return "ChannelErrorDetection"; }
