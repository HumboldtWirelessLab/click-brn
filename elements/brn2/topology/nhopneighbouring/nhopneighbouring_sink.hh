...
#ifndef NHOPNEIGHBOURINGSINKELEMENT_HH
#define NHOPNEIGHBOURINGSINKELEMENT_HH
...
class NHopNeighbouringSink : public BRNElement {
 ...
 public:
  ...
  const char *class_name() const  { return "NHopNeighbouringSink"; }
