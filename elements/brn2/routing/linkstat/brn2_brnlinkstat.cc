...
BRN2LinkStat::send_probe()
{
  ...
  *ptr = 255; ptr++;
  ...
  lp->_cksum = 0;
  lp->_cksum = click_in_cksum((unsigned char *) lp, sizeof(link_probe) /*+ num_entries * sizeof(link_entry)*/);
...
BRN2LinkStat::simple_action(Packet *p)
{
  ...
  if (click_in_cksum((unsigned char *) lp, sizeof(link_probe)/*ntohs(lp->_psz)*/) != 0) {
