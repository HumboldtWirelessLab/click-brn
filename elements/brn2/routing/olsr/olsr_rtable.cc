...
OLSRRoutingTable::compute_routing_table()
{
	...
	HashMap<OLSRIPPair, void *> *link_set = _linkInfo->get_link_set();
	HashMap<OLSRIPPair, void*> *twohop_set = _neighborInfo->get_twohop_set();
	HashMap<OLSRIPPair, void*> *topology_set = _topologyInfo->get_topology_set();
	HashMap<IPAddress, void*> *interface_set = _interfaceInfo->get_interface_set();
	HashMap<OLSRIPPair, void*> *association_set = _associationInfo->get_association_set();
