...
char* Brn2Logger::_buffer                  = NULL;
int Brn2Logger::_buffer_len                = 128;
HashMap<void*,String>* Brn2Logger::_id_map = NULL;
String* Brn2Logger::_s_na                  = NULL;

////////////////////////////////////////////////////////////////////////////////

const String&
Brn2Logger::get_id(const Element* elem)
{
  if (NULL == _id_map)
...
void 
Brn2Logger::log(int level, const char* format, va_list ptr) const
{
  if (NULL == _buffer)
