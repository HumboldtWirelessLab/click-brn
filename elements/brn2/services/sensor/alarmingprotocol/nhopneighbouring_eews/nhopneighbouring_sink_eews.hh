...
#ifndef NHOPNEIGHBOURINGSINKEEWSELEMENT_HH
#define NHOPNEIGHBOURINGSINKEEWSELEMENT_HH
...
class NHopNeighbouringSinkEews : public BRNElement {
 ...
 public:
  ...
  //methods
  //
  NHopNeighbouringSinkEews();
  ~NHopNeighbouringSinkEews();

  const char *class_name() const  { return "NHopNeighbouringSinkEews"; }
