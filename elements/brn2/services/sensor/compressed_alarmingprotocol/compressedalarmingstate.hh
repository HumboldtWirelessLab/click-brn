#ifndef COMPRESSEDALARMINGSTATEELEMENT_HH
#define COMPRESSEDALARMINGSTATEELEMENT_HH
...
class CompressedAlarmingState : public BRNElement {
 ...
 public:
  ...
  //methods
  //
  CompressedAlarmingState();
  ~CompressedAlarmingState();

  const char *class_name() const  { return "CompressedAlarmingState"; }
